...
echo "    1. Seed database with demo data (recommended method):"
echo "       ./gcp/seed-database.sh"
echo ""
echo "       Or manually via psql inside gcloud sql connect:"
echo "       gcloud sql connect $INSTANCE_NAME --user=eventku --database=eventku"
echo "       # Then in psql prompt: \\i backend/database/seed-data.sql"
echo ""
